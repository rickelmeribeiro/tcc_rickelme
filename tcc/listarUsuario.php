            ...
            <tr class="text-white" style="font-family: 'Segoe UI Light',sans-serif">
                ...
                <td>
                    ...
                    <button id="btnexc"
                        ...
                        <div class="sign">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Excluir Dados</title>
                    ...
                    <button onclick="abrirModalJsAlterar('<?php echo $idusuario ?>','id','ModalAlterar','A','alterarusuario','frmalterar','<?php echo $nomeusuario ?>', 'nome_usuario','<?php echo $cpfusuario ?>','cpf_usuario');"
                            class="Btngp mb-2 bg-primary">

                        <div class="sign">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Alterar Dados</title>
                    ...
                    <button onclick="abrirModalJsVerMais('<?php echo $idusuario ?>','id','ModalVerMais<?php echo $idusuario ?>','A');"
