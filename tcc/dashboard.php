...
<aside class=" sidebar position-fixed top-0 left-0 overflow-auto h-100 float-left" id="show-side-navigation1">
    ...
    <ul class="categories list-unstyled">
        <li class="hoverzin">
        <i onclick="carregaMenu('listarRegistro')" class=" cursordedinho mdi mdi-text-box-edit"></i><span onclick="carregaMenu('listarRegistro')" class="text-white cursordedinho" style="font-family: 'Segoe UI Semibold',sans-serif;">REGISTROS</span>
        </li>
        <li class="hoverzin">
            <i onclick="carregaMenu('listarUsuario')"  class=" cursordedinho mdi mdi-account-hard-hat"></i><span onclick="carregaMenu('listarUsuario')" class="text-white cursordedinho" style="font-family: 'Segoe UI Semibold',sans-serif;">USUÁRIOS</span>
        </li>
        <li class="hoverzin">
